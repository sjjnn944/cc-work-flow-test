...
<Do_Not_Use_When>
- src/ 또는 test/ 디렉토리가 아직 없을 때 (구현 완료 후 실행)
...
1. 필수 디렉토리/파일 존재 확인:
   ...
   - `test/` 디렉토리 — 없으면 "테스트 코드가 없습니다. 구현 완료 후 실행하세요." 출력 후 중단
...
5. 검증 계획 요약 출력:
   ...
   수행 단계:
     ...
     [6] 보안 검증    — verification-guide.md 7절 {--skip-security 시: [SKIP]}
